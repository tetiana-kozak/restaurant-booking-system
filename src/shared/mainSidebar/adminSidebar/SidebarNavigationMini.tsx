...
const SidebarNavigationMini = (props: Props) => {
  ...
  return (
    ...
    <div className="mb-[60px] ml-[0px] pt-[48px] h-[36px] w-[42px]">
        <img src={LogoSvg} alt="Table Flow Logo" className="h-[36px] w-[42px]" />
      </div>
